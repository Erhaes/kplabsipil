                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <p class="text-base md:text-lg text-gray-600">
                            Laboratorium Teknik Sipil Unsoed berfungsi sebagai pusat pembelajaran praktis
                            dan eksperimental yang dipergunakan oleh mahasiswa Fakultas Teknik Unsoed
                            dan pelayanan untuk mitra dari luar Laboratorium Teknik Sipil Unsoed yang
                            mencakup bidang Struktur dan Bahan Bangunan, Mekanika Tanah dan
                            Hidraulika, Transportasi, Mekanika Keairan dan Teknik Lingkungan.
                        </p>
                        <p class="text-base md:text-lg text-gray-600">
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="bg-gray-50 p-8 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <p class="flex items-center text-gray-600">
                                <svg class="h-6 w-6 mr-3 text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/>
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.8 13.938h-.011a7 7 0 1 0-11.464.144h-.016l.14.171c.1.127.2.251.3.371L12 21l5.13-6.248c.194-.209.374-.429.54-.659l.13-.155Z"/>
                                </svg>
                                Jl. Raya Mayjen Sungkono KM 5 Gedung D, Desa Blater, Kecamatan Kalimanah, Kabupaten Purbalingga, Jawa Tengah 53371
                            </p>
                            <p class="flex items-center text-gray-600">
                ...
                <div class="h-[400px]">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3956.330079266047!2d109.3357658!3d-7.428677!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e655986a5294e97%3A0x6ed179e2743fcd16!2sGedung%20Laboratorium%20Bersama%20FT%20UNSOED!5e0!3m2!1sen!2sid!4v1740909338103!5m2!1sen!2sid"
